...
data_arg.add_argument('--dataset', type=str, default='KAGGEL_HPAIC', choices=['Bright', 'DAPI', 'cTnT', 'Living', 'others'])
data_arg.add_argument('--train_path', type=str, default=r'C:\DATA\KAGGEL_HPAIC\forAB\AB\train')
