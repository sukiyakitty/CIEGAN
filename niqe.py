...
import math
import cv2
from utils import any_to_image, image_to_gray
...
def getNIQE(inputImgData):
    ...
    inputImgData = image_to_gray(inputImgData)
    ...
    if M < 192 or N < 192:
        inputImgData = cv2.resize(inputImgData, (192, 192), interpolation=cv2.INTER_NEAREST)
...
if __name__ == "__main__":
    ...
    print('NIQE of ref bikes image is: %0.3f' % getNIQE(ref))
    print('NIQE of dis bikes image is: %0.3f' % getNIQE(dis))
    ...
    print('NIQE of ref parrot image is: %0.3f' % getNIQE(ref))
    print('NIQE of dis parrot image is: %0.3f' % getNIQE(dis))
